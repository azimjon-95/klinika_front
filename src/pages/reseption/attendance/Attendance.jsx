...
const AttendanceDashboard = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useGetDailyReportQuery(formattedDate, {
  ...
  let data = attendanceData?.innerData.attendances;
                  ...
                  <tr key={record._id}>
                    <td>
                      {record?.employee_id?.firstName +
                        " " +
                        record?.employee_id?.lastName || "Mavjud emas"}
                    </td>
                    <td>
      ...
      <div className="calendar-section">
        ...
        <Calendar
          ...
          formatShortWeekday={(locale, date) =>
            uzbekLocale.weekdaysShort[date.getDay()]
          }
